...
angular.module('softvApp')
	.factory('reportesCortesCorporativaFactory', reportesCortesCorporativaFactory);


function reportesCortesCorporativaFactory($http, $q, globalService, $localStorage ) { //, sessionFactory) {
	var factory = {};
	var paths = {
