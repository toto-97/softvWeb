...
function PagarContadoCtrl($uibModal, $state, $rootScope, ngNotify, inMenu, $uibModalInstance, items, metodo, x, elem1, $localStorage, pagosMaestrosFactory, cajasFactory) {
